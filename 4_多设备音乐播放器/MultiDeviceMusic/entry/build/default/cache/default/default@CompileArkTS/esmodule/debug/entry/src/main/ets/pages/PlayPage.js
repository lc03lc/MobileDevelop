...
class PlayPage extends ViewPU {
    ...
    initialRender() {
            ...
            if (this.currentBreakpoint === PlayConstants.LG) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Tabs.vertical(false);
                        Tabs.barHeight({ "id": 16777318, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.height({ "id": 16777347, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Image.margin({ left: { "id": 16777483, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }, top: { "id": 16777346, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
    ...
    TabTitle(title, index, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(title);
            Text.fontColor(this.currentTabIndex === index ? { "id": 16777272, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777273, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            ...
            Text.border({
                width: { bottom: this.currentTabIndex === index ? { "id": 16777468, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : 0 },
                color: { "id": 16777272, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            });
            Text.padding({ bottom: { "id": 16777469, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
