...
export class PlayControlComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.width(this.index === PlayConstants.PLAY_INDEX ? new BreakpointType({
                sm: { "id": 16777443, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                md: { "id": 16777443, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                lg: { "id": 16777444, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
                ...
                lg: { "id": 16777439, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
    ...
    playControlClick(key) {
        switch (key) {
            ...
            case ControlConstants.PLAY:
                ...
                this.playControl.icon = { "id": 16777552, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" };
                this.playControl.key = ControlConstants.PAUSE;
                break;
            case ControlConstants.PAUSE:
                MediaService.getInstance().pause();
                this.playControl.icon = { "id": 16777549, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" };
    ...
    changePlayMode() {
        ...
        const resource = [{ "id": 16777558, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }, { "id": 16777534, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }, { "id": 16777537, "type": 20000, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }];
