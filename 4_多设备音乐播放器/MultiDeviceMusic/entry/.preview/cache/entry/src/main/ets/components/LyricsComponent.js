    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.margin({
                top: new BreakpointType({
                    ...
                    lg: { "id": 16777434, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontSize(new BreakpointType({
                sm: { "id": 16777360, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                md: { "id": 16777360, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                lg: { "id": 16777357, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            }).getValue(this.currentBreakpoint));
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.width({ "id": 16777382, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Image.aspectRatio(1);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.textAlign(TextAlign.Start);
            Text.fontSize(new BreakpointType({
                sm: { "id": 16777355, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                md: { "id": 16777355, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                lg: { "id": 16777353, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            }).getValue(this.currentBreakpoint));
            Text.fontColor({ "id": 16777253, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Text.margin({ top: { "id": 16777504, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
            Text.width(StyleConstants.FULL_WIDTH);
            if (!isInitialRender) {
                Text.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Scroll.create();
            Scroll.debugLine("components/LyricsComponent.ets(95:13)");
            // Text(PlayConstants.LYRICS_CONTENT)
            //   .fontSize(new BreakpointType({
            //     sm: $r('app.float.font_twenty'),
            //     md: $r('app.float.font_twenty'),
            ...
            //   .width(StyleConstants.FULL_WIDTH)
            //   .margin({ top: $r('app.float.lyrics_text_margin_top') })
            Scroll.margin({ top: { "id": 16777435, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } });
            if (!isInitialRender) {
                // Text(PlayConstants.LYRICS_CONTENT)
                //   .fontSize(new BreakpointType({
                //     sm: $r('app.float.font_twenty'),
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("components/LyricsComponent.ets(96:15)");
            Column.width('100%');
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create("作词 : 宋冬野\n作曲 : 宋冬野\n编曲 : 韦伟\n让我再看你一遍\n从南到北\n像是被五环路蒙住的双眼\n请你再讲一遍\n关于那天\n抱着盒子的姑娘\n和擦汗的男人\n我知道 那些夏天\n就像青春一样回不来\n代替梦想的也只能是勉为其难\n我知道 吹过的牛逼\n也会随青春一笑了之\n让我困在城市里\n纪念你\n让我再尝一口\n秋天的酒\n一直往南方开\n不会太久\n让我再听一遍\n最美的那一句\n你回家了\n我在等你呢\n我知道 那些夏天\n就像青春一样回不来\n代替梦想的也只能是勉为其难\n我知道 吹过的牛逼\n也会随青春一笑了之\n让我困在城市里 纪念你\n我知道 那些夏天\n就像你一样回不来\n我也不会再对谁满怀期待\n我知道 这个世界\n每天都有太多遗憾\n所以你好 再见");
            Text.debugLine("components/LyricsComponent.ets(97:17)");
            Text.fontSize(new BreakpointType({
                sm: { "id": 16777359, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
