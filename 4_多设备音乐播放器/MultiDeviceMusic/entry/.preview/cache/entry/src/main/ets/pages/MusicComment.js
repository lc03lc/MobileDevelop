...
class MusicComment extends ViewPU {
    ...
    ShowTitle(title, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/MusicComment.ets(34:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(title);
            Text.debugLine("pages/MusicComment.ets(35:7)");
            Text.fontSize({ "id": 16777335, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Text.fontColor({ "id": 16777234, "type": 10001, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Text.lineHeight({ "id": 16777511, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
            Text.fontWeight(FontWeight.Medium);
            Text.margin({
                top: { "id": 16777513, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                bottom: { "id": 16777512, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                left: this.currentBp === BreakpointConstants.BREAKPOINT_SM ? { "id": 16777438, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777436, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                right: this.currentBp === BreakpointConstants.BREAKPOINT_SM ? { "id": 16777441, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777439, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            });
            if (!isInitialRender) {
                Text.pop();
            }
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridRow.debugLine("pages/MusicComment.ets(54:5)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            GridCol.debugLine("pages/MusicComment.ets(66:7)");
            if (!isInitialRender) {
                GridCol.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/MusicComment.ets(73:9)");
        ...
        __Common__.pop();
        this.ShowTitle.bind(this)({ "id": 16777295, "type": 10003, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("pages/MusicComment.ets(92:11)");
            ...
            List.divider({
                ...
                startMargin: this.currentBp === BreakpointConstants.BREAKPOINT_SM ? { "id": 16777499, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777500, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                endMargin: this.currentBp === BreakpointConstants.BREAKPOINT_SM ?
                    0 : { "id": 16777350, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            });
            List.margin({
                left: this.currentBp === BreakpointConstants.BREAKPOINT_SM ? { "id": 16777438, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777437, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                right: this.currentBp === BreakpointConstants.BREAKPOINT_SM ? { "id": 16777441, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" } : { "id": 16777440, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
            });
            if (!isInitialRender) {
                List.pop();
            }
                                    ...
                                    this.ifElseBranchUpdateFunction(0, () => {
                                        {
                                            ...
                                            const itemCreation = (elmtId, isInitialRender) => {
                                                ...
                                                ListItem.padding({
                                                    bottom: { "id": 16777466, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
                                                });
                                                ListItem.debugLine("pages/MusicComment.ets(97:19)");
                                                if (!isInitialRender) {
                                                    ListItem.pop();
                                                }
                                                ViewStackProcessor.StopGetAccessRecording();
                                                ...
                                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                                    ...
                                                    __Common__.margin({
                                                        left: this.currentBp === BreakpointConstants.BREAKPOINT_SM ?
                                                            0 : { "id": 16777437, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" },
                                                        right: this.currentBp === BreakpointConstants.BREAKPOINT_SM ?
                                                            0 : { "id": 16777440, "type": 10002, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" }
                                                    });
                                                    if (!isInitialRender) {
                                                        __Common__.pop();
                                                    }
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            {
                                ...
                                const itemCreation = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.debugLine("pages/MusicComment.ets(112:17)");
                                    if (!isInitialRender) {
                                        ListItem.pop();
                                    }
                                    ViewStackProcessor.StopGetAccessRecording();
        ...
        ForEach.pop();
        List.pop();
        this.ShowTitle.bind(this)({ "id": 16777285, "type": 10003, params: [], "bundleName": "com.huawei.multidevicemusic", "moduleName": "entry" });
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            List.create();
            List.debugLine("pages/MusicComment.ets(147:11)");
            List.layoutWeight(1);
            List.lanes(this.currentBp === BreakpointConstants.BREAKPOINT_LG ? 2 : 1);
            List.scrollBar(BarState.Off);
            List.margin({
            ...
            const forEachItemGenFunction = _item => {
                const comment = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("pages/MusicComment.ets(149:15)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
