...
public class GameAbilitySlice2 extends AbilitySlice {
    ...
    private int blackImgid = ResourceTable.Id_pic_ib33_2;        // 定义缺少图片的id，默认是最后一个
    private int steps;      // 定义步骤计数
    private TickTimer tickTimer;        // 定义计时器
    private int[] image = {     // 存放图片碎片的数组
            ResourceTable.Media_image_2_11, ResourceTable.Media_image_2_12, ResourceTable.Media_image_2_13,
            ResourceTable.Media_image_2_21, ResourceTable.Media_image_2_22, ResourceTable.Media_image_2_23,
            ResourceTable.Media_image_2_31, ResourceTable.Media_image_2_32, ResourceTable.Media_image_2_33
    };
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_ability_game2);
    ...
    private void initComponent() {       // 初始化控件
        ib11 = findComponentById(ResourceTable.Id_pic_ib11_2);
        ib12 = findComponentById(ResourceTable.Id_pic_ib12_2);
        ib13 = findComponentById(ResourceTable.Id_pic_ib13_2);
        ib21 = findComponentById(ResourceTable.Id_pic_ib21_2);
        ib22 = findComponentById(ResourceTable.Id_pic_ib22_2);
        ib23 = findComponentById(ResourceTable.Id_pic_ib23_2);
        ib31 = findComponentById(ResourceTable.Id_pic_ib31_2);
        ib32 = findComponentById(ResourceTable.Id_pic_ib32_2);
        ib33 = findComponentById(ResourceTable.Id_pic_ib33_2);
...
//            cd.setAutoClosable(true);
    ...
    public void restart() {     // 游戏重试控件定义
        ...
        Image blackBtn = findComponentById(ResourceTable.Id_pic_ib33_2);
        blackBtn.setVisibility(Component.INVISIBLE);

        //初始化空白区域的按钮id
        blackImgid = ResourceTable.Id_pic_ib33_2;
