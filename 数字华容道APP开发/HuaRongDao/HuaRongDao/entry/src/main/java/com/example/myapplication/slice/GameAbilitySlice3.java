...
public class GameAbilitySlice3 extends AbilitySlice {
    ...
    private int blackImgid = ResourceTable.Id_pic_ib44_3;        // 定义缺少图片的id，默认是最后一个
    private int steps;      // 定义步骤计数
    private TickTimer tickTimer;        // 定义计时器
    private int[] image = {     // 存放图片碎片的数组
            ResourceTable.Media_image_3_11, ResourceTable.Media_image_3_12, ResourceTable.Media_image_3_13, ResourceTable.Media_image_3_14,
            ResourceTable.Media_image_3_21, ResourceTable.Media_image_3_22, ResourceTable.Media_image_3_23, ResourceTable.Media_image_3_24,
            ResourceTable.Media_image_3_31, ResourceTable.Media_image_3_32, ResourceTable.Media_image_3_33, ResourceTable.Media_image_3_34,
            ResourceTable.Media_image_3_41, ResourceTable.Media_image_3_42, ResourceTable.Media_image_3_43, ResourceTable.Media_image_3_44,
    };
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_ability_game3);
    ...
    private void initComponent() {       // 初始化控件
        ib11 = findComponentById(ResourceTable.Id_pic_ib11_3);
        ib12 = findComponentById(ResourceTable.Id_pic_ib12_3);
        ib13 = findComponentById(ResourceTable.Id_pic_ib13_3);
        ib14 = findComponentById(ResourceTable.Id_pic_ib14_3);
        ib21 = findComponentById(ResourceTable.Id_pic_ib21_3);
        ib22 = findComponentById(ResourceTable.Id_pic_ib22_3);
        ib23 = findComponentById(ResourceTable.Id_pic_ib23_3);
        ib24 = findComponentById(ResourceTable.Id_pic_ib24_3);
        ib31 = findComponentById(ResourceTable.Id_pic_ib31_3);
        ib32 = findComponentById(ResourceTable.Id_pic_ib32_3);
        ib33 = findComponentById(ResourceTable.Id_pic_ib33_3);
        ib34 = findComponentById(ResourceTable.Id_pic_ib34_3);
        ib41 = findComponentById(ResourceTable.Id_pic_ib41_3);
        ib42 = findComponentById(ResourceTable.Id_pic_ib42_3);
        ib43 = findComponentById(ResourceTable.Id_pic_ib43_3);
        ib44 = findComponentById(ResourceTable.Id_pic_ib44_3);
...
//            cd.setAutoClosable(true);
    ...
    public void restart() {     // 游戏重试控件定义
        ...
        Image blackBtn = findComponentById(ResourceTable.Id_pic_ib44_3);
        blackBtn.setVisibility(Component.INVISIBLE);

        //初始化空白区域的按钮id
        blackImgid = ResourceTable.Id_pic_ib44_3;
